    ...
    public function run(): void
    {
        $newsData = [
            ...
            [
                ...
                'category' => 'Teknologi',
                'thumbnail_url' => 'https://picsum.photos/600/400?random=4',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
            [
                ...
                'category' => 'Lingkungan',
                'thumbnail_url' => 'https://picsum.photos/600/400?random=5',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
            [
                ...
                'category' => 'Gaya Hidup',
                'thumbnail_url' => 'https://picsum.photos/600/400?random=6',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
            [
                ...
                'thumbnail_url' => 'https://picsum.photos/600/400?random=7',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
            [
                ...
                'category' => 'Penelitian',
                'thumbnail_url' => 'https://picsum.photos/600/400?random=8',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
            [
                ...
                'category' => 'Event',
                'thumbnail_url' => 'https://picsum.photos/600/400?random=9',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
            [
                ...
                'category' => 'Teknologi',
                'thumbnail_url' => 'https://picsum.photos/600/400?random=10',
                'published_at' => now()->subDays(rand(1, 30)),
            ],
        ];
